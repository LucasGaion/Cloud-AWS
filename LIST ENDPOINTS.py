...
for contas in accounts:
    ...
    for region in regions:
        try:
            ...
            internetgateways = ec2_client.describe_internet_gateways()

            for gateway in internetgateways['InternetGateways']:
                worksheet.append([
                    contas['Name'],
                    region,
...
data = date.today()
sheetINTERNET = f'LIST INTERNET GATEWAY - {data}.xlsx'
workbook.save(filename=sheetINTERNET)
print(f'Salvo com sucesso: {sheetINTERNET}')
