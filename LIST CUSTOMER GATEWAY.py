...
for contas in accounts:
    ...
    for region in regions:
        try:
            ...
            customer = ec2_client.describe_customer_gateways()

            for gateway in customer['CustomerGateways']:
                worksheet.append([
                    contas['Name'],
                    region,
...
data = date.today()
sheetGATEWAY = f'LIST CUSTOMERS GATEWAY - {data}.xlsx'
workbook.save(filename=sheetGATEWAY)
print(f'Salvo com sucesso: {sheetGATEWAY}')
